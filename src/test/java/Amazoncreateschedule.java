...
public class Amazoncreateschedule 
{
    WebDriver driver;
    ...
    public void setup() throws InterruptedException
    {
       ...
       driver.switchTo().frame(iframeElement);
        ...
        WebElement newScheduleButton = driver.findElement(By.xpath(AWSXpaths.SCHEDULE_BUTTON_FIELD));
        ...
        WebElement select = driver.findElement(By.xpath(AWSXpaths.SELECT_OPTION));
        select.click();
